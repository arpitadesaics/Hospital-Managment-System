 ...
 * @author DELL
 */
public class patientHspAdmin extends javax.swing.JPanel {

    /**
     * Creates new form patientHspAdmin
     */
    patientArrayList p;
    cityArrayList c;
    communityArrayList co;
    houseArrayList ho;
    public patientHspAdmin(patientArrayList p,cityArrayList c,communityArrayList co,houseArrayList ho) {
        initComponents();
        this.p = p;
        this.c=c;
        this.co=co;
